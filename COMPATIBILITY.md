...
| `src/model_migration_kit/dimensions.py` | `DEFAULT_CONFIDENCE`, `EvidenceRecord`, `wilson_interval` |
...
| `tests/test_dimensions.py` | `DEFAULT_CONFIDENCE`, `EvidenceRecord`, `wilson_interval` |
